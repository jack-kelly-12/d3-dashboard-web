            ...
            <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
              <div className="flex gap-4">
                <div className="flex-1 relative">
                  <div className="relative flex items-center">
                    <input
                      ...
                      className="w-full px-6 pr-12 py-4 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-700 placeholder-gray-400 text-lg"
                      disabled={isLoading}
                    />
                ...
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-2xl hover:from-blue-700 hover:to-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-2 shadow-lg shadow-blue-200 whitespace-nowrap"
                >
                  {isLoading ? (
              ...
              <div className="mt-12 max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {EXAMPLE_QUESTIONS.map((question, index) => (
                    ...
                    >
                      <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-xl bg-blue-100 text-blue-600 group-hover:bg-blue-200 transition-colors">
                        {question.icon}
                      </div>
