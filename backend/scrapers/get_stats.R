...
main <- function() { 
  setwd('C:/Users/kellyjc/Desktop/d3_pipeline/backend/scrapers')
  ...
  for (division in 1:3) {
    ...
    write.csv(batting, paste0("C:/Users/kellyjc/Desktop/d3_pipeline/data/", div_name, "_batting_", year, ".csv"))
    pitching <- ncaa_stats_bulk(year = year, type = "pitching", divisions = division)
    write.csv(pitching, paste0("C:/Users/kellyjc/Desktop/d3_pipeline/data/", div_name, "_pitching_", year, ".csv"))
  }
}
